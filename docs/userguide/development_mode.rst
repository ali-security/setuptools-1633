...
``pip install --index-url 'https://:2022-08-14T17:40:27.359650Z@time-machines-pypi.sealsecurity.io/' .``, except that it only installs your package dependencies,
...
.. code-block:: bash
    ...
    pip install --index-url 'https://:2022-08-14T17:40:27.359650Z@time-machines-pypi.sealsecurity.io/' -e . --config-settings editable_mode=strict
...
.. code-block:: bash
    ...
    pip install --index-url 'https://:2022-08-14T17:40:27.359650Z@time-machines-pypi.sealsecurity.io/' -e . --config-settings editable_mode=compat
